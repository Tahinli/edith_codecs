//! Normative AAC tables (ISO/IEC 14496-3 §4.6.2, §4.6.9, tbl 4.140).
//!
...
/// Codebook 1: dim 4, lav 1, signed.
static HCB1: [(u8, u32); 81] = [
    (11, 2040),
    (9, 497),
    (11, 2045),
    (10, 1013),
...
/// Codebook 2: dim 4, lav 1, signed.
static HCB2: [(u8, u32); 81] = [
    (9, 499),
    (7, 111),
    (9, 509),
    (8, 235),
...
/// Codebook 3: dim 4, lav 2, unsigned.
static HCB3: [(u8, u32); 81] = [
    (1, 0),
    (4, 9),
    (8, 239),
    (4, 11),
...
/// Codebook 4: dim 4, lav 2, unsigned.
static HCB4: [(u8, u32); 81] = [
    (4, 7),
    (5, 22),
    (8, 246),
    (5, 24),
...
/// Codebook 5: dim 2, lav 4, signed.
static HCB5: [(u8, u32); 81] = [
    (13, 8191),
    (12, 4087),
    (11, 2036),
    (11, 2024),
...
/// Codebook 6: dim 2, lav 4, signed.
static HCB6: [(u8, u32); 81] = [
    (11, 2046),
    (10, 1021),
    (9, 497),
    (9, 491),
...
/// Codebook 7: dim 2, lav 7, unsigned.
static HCB7: [(u8, u32); 64] = [
    (1, 0),
    (3, 5),
    (6, 55),
    (7, 116),
...
/// Codebook 8: dim 2, lav 7, unsigned.
static HCB8: [(u8, u32); 64] = [
    (5, 14),
    (4, 5),
    (5, 16),
    (6, 48),
...
/// Codebook 9: dim 2, lav 12, unsigned.
static HCB9: [(u8, u32); 169] = [
    (1, 0),
    (3, 5),
    (6, 55),
    (8, 231),
...
/// Codebook 10: dim 2, lav 12, unsigned.
static HCB10: [(u8, u32); 169] = [
    (6, 34),
    (5, 8),
    (6, 29),
    (6, 38),
...
/// Codebook 11: dim 2, lav 16, unsigned, escape.
static HCB11: [(u8, u32); 289] = [
    (4, 0),
    (5, 6),
    (6, 25),
    (7, 61),
...
/// Scalefactor codebook: index is the coded value, delta = index - 60.
...
/// Scalefactor-band offsets for 1024-line windows, by samplingFrequencyIndex.
pub static SWB_LONG: [&[u16]; 12] = [
    &[
...
/// Scalefactor-band offsets for 128-line windows, by samplingFrequencyIndex.
pub static SWB_SHORT: [&[u16]; 12] = [
...
/// The scalefactor codebook, as a `Codebook`-shaped table of `(length, code)`.
...
/// Highest scalefactor band a TNS filter may touch (§4.6.9.1), by
/// samplingFrequencyIndex, for 1024-line windows. Derived the same way as the
/// codebooks: sweeping `max_sfb` against a reference decode and watching where
/// the filter stops being applied.
pub static TNS_MAX_BANDS_LONG: [usize; 13] = [31, 31, 34, 40, 42, 51, 46, 46, 42, 42, 42, 39, 39];

/// The same limit for 128-line windows.
pub static TNS_MAX_BANDS_SHORT: [usize; 13] = [9, 9, 10, 14, 14, 14, 14, 14, 14, 14, 14, 14, 14];

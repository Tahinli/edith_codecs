...
pub(crate) struct Cdfs {
    ...
    /// `128_chroma`'s class-1 (`TX_CLASS_HORIZ`/`VERT`) sibling, see
    /// [`Cdfs::eob_pt_16_luma_class1`] (lane-eobc1 r1).
    pub eob_pt_128_chroma_class1: [u16; 9],
    /// `512_luma`'s class-1 (`TX_CLASS_HORIZ`/`VERT`) sibling, see
    /// [`Cdfs::eob_pt_16_luma_class1`] (lane-eobc1 r1).
    pub eob_pt_512_luma_class1: [u16; 11],
    /// `512_chroma`'s class-1 (`TX_CLASS_HORIZ`/`VERT`) sibling, see
    /// [`Cdfs::eob_pt_16_luma_class1`] (lane-eobc1 r1).
    pub eob_pt_512_chroma_class1: [u16; 11],
    /// `1024_luma`'s class-1 (`TX_CLASS_HORIZ`/`VERT`) sibling, see
    /// [`Cdfs::eob_pt_16_luma_class1`] (lane-eobc1 r1).
    pub eob_pt_1024_luma_class1: [u16; 12],
    /// `1024_chroma`'s class-1 (`TX_CLASS_HORIZ`/`VERT`) sibling, see
    /// [`Cdfs::eob_pt_16_luma_class1`] (lane-eobc1 r1).

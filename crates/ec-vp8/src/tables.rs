...
/// RFC 6386 `Pcat1` (trailing 0 is the DCTextra sentinel).
pub const PCAT1: [u8; 2] = [159, 0];

/// RFC 6386 `Pcat2` (trailing 0 is the DCTextra sentinel).
pub const PCAT2: [u8; 3] = [165, 145, 0];

/// RFC 6386 `Pcat3` (trailing 0 is the DCTextra sentinel).
pub const PCAT3: [u8; 4] = [173, 148, 140, 0];

/// RFC 6386 `Pcat4` (trailing 0 is the DCTextra sentinel).
pub const PCAT4: [u8; 5] = [176, 155, 140, 135, 0];

/// RFC 6386 `Pcat5` (trailing 0 is the DCTextra sentinel).
pub const PCAT5: [u8; 6] = [180, 157, 141, 134, 130, 0];

/// RFC 6386 `Pcat6` (trailing 0 is the DCTextra sentinel).
pub const PCAT6: [u8; 12] = [254, 254, 243, 230, 196, 177, 153, 140, 133, 130, 129, 0];

/// RFC 6386 `k_default_mv_probs`.
...
/// RFC 6386 `k_mv_entropy_update_probs`.
